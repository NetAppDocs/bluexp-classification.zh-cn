...
.步骤
. 从_Configuration_页面中、选择image:button-gallery-options.gif["更多按钮"]OneDrive、SharePoint或Google Drive帐户行中的按钮、然后选择*删除OneDrive帐户*、*删除SharePoint帐户*或*删除Google Drive帐户*。
+
