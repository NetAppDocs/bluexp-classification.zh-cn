...
请注意，您可以 link:task-managing-compliance.html#removing-a-onedrive-sharepoint-or-google-drive-account-from-bluexp-classification["从BlueXP分类中删除整个OneDrive帐户"] 如果您不想再扫描OneDrive帐户中的任何用户数据。
