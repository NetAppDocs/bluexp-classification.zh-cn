...
如果将Data sense安装在无法访问Internet的站点上、则Cloud Manager Connector也必须安装在无法访问Internet的同一站点上。 https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-install-connector-onprem-no-internet.html["了解更多信息。"^]。
