...
summary: 完成以下几个步骤、将Data sense部署在网络中的Linux主机或云中可访问Internet的Linux主机上。 
---
...
如果您还没有 Connector ， https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-installing-linux.html["在内部部署 Connector"^] 在网络中的Linux主机或云中的Linux主机上。
...
* * AWS EC2实例类型*：满足上述CPU和RAM要求的实例类型。我们建议您这样做 https://aws.amazon.com/ec2/instance-types/m5/["m5.4xlarge"^]。
* * Azure VM size*：满足上述CPU和RAM要求的实例类型。我们建议您这样做 https://docs.microsoft.com/en-us/azure/virtual-machines/dv3-dsv3-series#dsv3-series["标准D16s_v3"^]。
* * GCP计算机类型*：满足上述CPU和RAM要求的实例类型。我们建议您这样做 https://cloud.google.com/compute/docs/general-purpose-machines#n2_machines["n2-standard-16"^]。
