...
.要求
* 您必须具有复制文件的权限。link:concept-cloud-compliance.html["了解用户对合规性信息的访问权限"] 。
...
.要求
* 您必须具有复制和同步文件的权限。link:concept-cloud-compliance.html["了解用户对合规性信息的访问权限"] 。
* 您必须至少选择20个文件。
...
.要求
* 您必须具有移动文件的权限。link:concept-cloud-compliance.html["了解用户对合规性信息的访问权限"] 。
...
.要求
* 您必须具有删除文件的权限。link:concept-cloud-compliance.html["了解用户对合规性信息的访问权限"] 。
