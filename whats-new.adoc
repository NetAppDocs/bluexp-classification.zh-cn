...
现在、您可以将Data sense BYOL许可证上传到位于非公开站点的Digital Wallet中、以便在许可证不足时收到通知。 https://docs.netapp.com/us-en/cloud-manager-data-sense/task-licensing-datasense.html#obtain-your-cloud-data-sense-license-file["了解如何获取和上传Data sense BYOL许可证"]。
