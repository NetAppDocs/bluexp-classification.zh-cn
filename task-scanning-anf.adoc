...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-1.png["一个"]发现要扫描的Azure NetApp Files系统
[role="quick-margin-para"]
在扫描Azure NetApp Files卷之前， https://docs.netapp.com/us-en/bluexp-azure-netapp-files/task-quick-start.html["必须设置BlueXP才能发现配置"^]。
