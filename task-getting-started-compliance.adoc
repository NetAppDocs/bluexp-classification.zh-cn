...
* 对于内部ONTAP系统、 https://docs.netapp.com/us-en/bluexp-ontap-onprem/task-discovering-ontap.html["BlueXP必须发现ONTAP 集群"^]
...
您的Cloud Volumes ONTAP 系统应已在BlueXP的"画布"中可用。对于内部部署的ONTAP系统，您需要具有 https://docs.netapp.com/us-en/bluexp-ontap-onprem/task-discovering-ontap.html["BlueXP会发现这些集群"^]。
