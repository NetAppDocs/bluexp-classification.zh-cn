...
+
https://["适用于 Linux 实例的 AWS 安全组"^]

+
https://["适用于 Windows 实例的 AWS 安全组"^]

+
https://["AWS 弹性网络接口（ ENI ）"^]
...
在扫描 ONTAP 卷的 FSX 之前， https://["您必须具有配置了卷的 FSX 工作环境"^]。
...
https://["了解如何在BlueXP中发现或创建适用于ONTAP 的FSX文件系统"^]。
