...
[]
====
*注*此信息仅与BlueXP  分类旧版1.3及更早版本相关。2023年12月(v1.26.6)版本删除了使用Azure信息保护(AIP)标签集成数据的选项。

====
* 如果您订阅了 https://azure.microsoft.com/en-us/services/information-protection/["Azure 信息保护（ AIP ）"^]以对文件进行分类和保护、则可以使用BlueXP  分类来管理这些AIP标签。
